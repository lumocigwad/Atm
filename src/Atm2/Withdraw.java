...
try {
          ...
          pst.executeUpdate();
          conn.close();
          JOptionPane.showMessageDialog(null, "Amount was withdrawn successful","CONTINUE",JOptionPane.INFORMATION_MESSAGE);
          Confirm free=new Confirm();
          free.setVisible(true);
          dispose();
          }
              else{
                   JOptionPane.showMessageDialog(null,"You have insufficient balance please recharge your account","Access denied", JOptionPane.ERROR_MESSAGE);
              }}
          else{
              JOptionPane.showMessageDialog(null,"ACCOUNT NUMBER IS INVALID","Access denied", JOptionPane.ERROR_MESSAGE);
          }
         }
